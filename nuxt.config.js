...
export default {
  ...
  env: {
    ...
    TOKEN_WQT_ADDRESS_RINKEBY: process.env.BRIDGE_ADDRESS_RINKEBY,
    TOKEN_BNB_ADDRESS_RINKEBY: process.env.TOKEN_BNB_ADDRESS_RINKEBY,
    BRIDGE_ADDRESS_BSCTESTNET: process.env.BRIDGE_ADDRESS_BSCTESTNET,
    TOKEN_WQT_ADDRESS_BSCTESTNET: process.env.TOKEN_WQT_ADDRESS_BSCTESTNET,
