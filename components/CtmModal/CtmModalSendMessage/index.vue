<template>
  <ctm-modal-box
    class="message"
    :title="$tc('modals.titles.sendPrivateMessage')"
  >
              ...
              <div class="btn__container">
                <div class="btn__wrapper">
                  <base-btn
                    ...
                    @click="handleSubmit(handleSendMsg)"
                  >
                    {{ $t('meta.btns.send') }}
                  </base-btn>
                </div>
...
export default {
  ...
  methods: {
    ...
    async handleSendMsg() {
      ...
      const { ok: isChatCreated, result } = await this.$store.dispatch('chat/handleCreatePrivateChat', { userId, medias, text: this.text });
